	...
	<xsl:template match="/">
		<metadata>
			...
			<!-- ============================================
		      GIVE Properties
		    =============================================== -->
			<xsl:attribute name="designationNumber"><xsl:value-of select="$xSiebelDesignation_6_200" /></xsl:attribute>
			<xsl:attribute name="parentDesignation"><xsl:value-of select="$xSiebelParentDesignation_6_200" /></xsl:attribute>
			<xsl:attribute name="organizationId"><xsl:value-of select="$xSiebelOrganizationId_6_200" /></xsl:attribute>
